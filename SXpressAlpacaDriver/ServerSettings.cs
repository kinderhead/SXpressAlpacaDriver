...
namespace SXpressAlpacaDriver
{
    internal static class ServerSettings
    {
        ...
        internal static ASCOM.Tools.XMLProfile Profile = new(Program.DriverID, "Server");
        ...
        internal struct FilterWheel
        {
            internal static bool Patch
            {
                get
                {
                    if (bool.TryParse(Profile.GetValue("FilterWheelPatch", true.ToString()), out bool result))
                    {
                        return result;
                    }
                    return true;
                ...
                set
                {
                    Profile.WriteValue("FilterWheelPatch", value.ToString());
                }
            }
            ...
            internal static ushort Timeout
            {
                get
                {
                    if (ushort.TryParse(Profile.GetValue("FilterWheelTimeout", 15.ToString()), out ushort result))
                    {
                        return result;
                    }
                    return 15;
                ...
                set
                {
                    Profile.WriteValue("FilterWheelTimeout", value.ToString());
                }
            }
        }
