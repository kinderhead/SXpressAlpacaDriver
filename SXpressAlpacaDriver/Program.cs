...
namespace SXpressAlpacaDriver
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Logger = new DualLogger("SXpressAlpacaDriver");
            ...
            #if DEBUG
            var controller = new TestFilterWheelController(9);
            #else
            var controller = new HidController();
            #endif

            ASCOM.Alpaca.DeviceManager.LoadFilterWheel(0, new DeviceAccess.FilterWheel.Driver(controller), "Starlight Xpress Universal Filter Wheel Driver", ServerSettings.GetDeviceUniqueId("FilterWheel", 0));
